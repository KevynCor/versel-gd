...
export const EstadoBadge = ({ estado }) => {
  const config = {
    ...
    DEVUELTO:    { style: "bg-indigo-50 text-indigo-700 border-indigo-200", label: "Devuelto" },
    ...
    DEVUELTO_TOTAL: { style: "bg-gray-100 text-gray-600 border-gray-200", label: "Devuelto Total" }
  };
